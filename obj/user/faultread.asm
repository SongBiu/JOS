	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800256:	0f be 84 06 04 ef ff 	movsbl -0x10fc(%esi,%eax,1),%eax
  80025d:	ff 
  80025e:	50                   	push   %eax
...
008002ab <vprintfmt>:
{
  ...
  800329:	03 8c 83 94 ef ff ff 	add    -0x106c(%ebx,%eax,4),%ecx
...
0080042b <.L31>:
  ...
  800448:	52                   	push   %edx
  800449:	8d 83 25 ef ff ff    	lea    -0x10db(%ebx),%eax
  80044f:	50                   	push   %eax
  ...
  800466:	50                   	push   %eax
  800467:	8d 83 1c ef ff ff    	lea    -0x10e4(%ebx),%eax
  80046d:	50                   	push   %eax
...
00800484 <.L36>:
  ...
  800494:	8d 83 15 ef ff ff    	lea    -0x10eb(%ebx),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c0d:	8d 83 ec f0 ff ff    	lea    -0xf14(%ebx),%eax
  800c13:	50                   	push   %eax
  800c14:	6a 26                	push   $0x26
  800c16:	8d 83 09 f1 ff ff    	lea    -0xef7(%ebx),%eax
  800c1c:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c72:	57                   	push   %edi
  800c73:	50                   	push   %eax
  800c74:	8d 83 18 f1 ff ff    	lea    -0xee8(%ebx),%eax
  800c7a:	50                   	push   %eax
  ...
  800c87:	e8 a5 f4 ff ff       	call   800131 <vcprintf>
	cprintf("\n");
  800c8c:	8d 83 f8 ee ff ff    	lea    -0x1108(%ebx),%eax

	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023f:	0f be 84 06 f4 ee ff 	movsbl -0x110c(%esi,%eax,1),%eax
  800246:	ff 
  800247:	50                   	push   %eax
...
00800294 <vprintfmt>:
{
  ...
  800312:	03 8c 83 84 ef ff ff 	add    -0x107c(%ebx,%eax,4),%ecx
...
00800414 <.L31>:
  ...
  800431:	52                   	push   %edx
  800432:	8d 83 15 ef ff ff    	lea    -0x10eb(%ebx),%eax
  800438:	50                   	push   %eax
  ...
  80044f:	50                   	push   %eax
  800450:	8d 83 0c ef ff ff    	lea    -0x10f4(%ebx),%eax
  800456:	50                   	push   %eax
...
0080046d <.L36>:
  ...
  80047d:	8d 83 05 ef ff ff    	lea    -0x10fb(%ebx),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf6:	8d 83 dc f0 ff ff    	lea    -0xf24(%ebx),%eax
  800bfc:	50                   	push   %eax
  800bfd:	6a 23                	push   $0x23
  800bff:	8d 83 f9 f0 ff ff    	lea    -0xf07(%ebx),%eax
  800c05:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c5b:	57                   	push   %edi
  800c5c:	50                   	push   %eax
  800c5d:	8d 83 08 f1 ff ff    	lea    -0xef8(%ebx),%eax
  800c63:	50                   	push   %eax
  ...
  800c70:	e8 a5 f4 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800c75:	8d 83 e8 ee ff ff    	lea    -0x1118(%ebx),%eax

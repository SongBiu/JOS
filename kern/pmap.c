...
page_init(void)
{
	...
	/*
		As we know, we allocated memory pages from down to up, so the down
		page link to its up one;
		We must mark pages from up to down;
		The page_free_list point to the first free page from down to up; And
		all pages point its up one just jump the IO hole;
	*/
